...
2025 年下半年我看过一段不到两分钟的内部 demo。一台双臂 VLA 机器人在做收拾餐桌：先把脏碗一个一个放进水池，然后回桌上擦水迹。前 60 秒非常漂亮，每个碗的位姿都对得上，水池里没有任何剐蹭。

第 90 秒它做了一件让全屋人安静下来的事：**把一个已经放进水池的碗又拿了回来**，重新放到餐桌上，然后伸手去抓它，再放回水池。

来回三趟。没有报错，没有犹豫，电机声音平稳，姿态优美。它认认真真地进入了一个死循环，直到旁边工程师把急停按下。
